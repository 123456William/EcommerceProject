 @include('frontend.header')
    ...
    <main id="main" class="main-site">
        ...
        <div class="container">
            <!galley-- <div class="main-content-area"> 
            <div class="aboutus-info style-center">
                <b class="box-title">Interesting Facts</b>
                <p class="txt-content">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the dummy text ever since the 1500s, when an unknown printer took a  of type</p>
            </div>
